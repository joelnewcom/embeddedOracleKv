 ...
 * </code></pre>
 * More details are available at <a href="https://www.oracle.com/pls/topic/lookup?ctx=en/database/other-databases/nosql-database/19.1&amp;id=NSKVJ-GUID-C1E4D281-2285-498A-BC12-858A5DFCF4F7">
 * kvlite Utility Command Line Parameter Options</a> and
 * <a href="https://www.oracle.com/pls/topic/lookup?ctx=en/database/other-databases/nosql-database/19.1&amp;id=NSSEC-GUID-6C5875FE-9765-45E6-9EC7-0D6EAEE3F95D">
...
public class SequenceNumber {
     ...
     * the store, making a maximum of noOfRetries attempts.<p>
     *
     * There are three possible outcomes when calling this method:
     * <ul>
     * <li> the next number in the sequence is returned.
     * <li> the maximum number of retries is reached for trying to
     *      synchronize with the store and a RuntimeException is thrown
     * <li> other exception if thrown by the store
     * </ul>
     * @return the next number in the sequence
     * @see <a href="../../java-api/oracle/kv/KVStore.html#readExceptions">Read
     * exceptions</a>
     * @see <a href="../../java-api/oracle/kv/KVStore.html#writeExceptions">
     * Write exceptions</a>
     */
