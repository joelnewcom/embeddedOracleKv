...
public class JVMStats implements ConciseStats, Serializable {
    ...
    public static class CollectorInfo implements Serializable {
         ...
         * constructed.
         *
         * @see GarbageCollectorMXBean#getCollectionCount
         ...
         * constructed.
         *
         * @see GarbageCollectorMXBean#getCollectionTime
     ...
     * to the value returned by
     * {@link Runtime#freeMemory() Runtime.freeMemory} at the time
     * this object is constructed.
     *
     * @see Runtime#freeMemory Runtime.freeMemory
     */
     ...
     * {@link Runtime#maxMemory() Runtime.maxMemory} (or for Zing,
     * a JVM-specific method) at the time this object is constructed.
     *
     * @see Runtime#maxMemory() Runtime.maxMemory
     */
     ...
     * to the value returned by
     * {@link Runtime#totalMemory() Runtime.totalMemory} at the time
     * this object is constructed.
     *
     * @see Runtime#totalMemory() Runtime.totalMemory
     */
